...
def _build_app():
    ...
    from arxiv_intel.fetcher import FetchCoordinator
    from arxiv_intel.analyzer import PaperAnalyzer, DirectionAnalyzer, KnowledgeAnalyzer
    from arxiv_intel.reporter import DailyReporter, KnowledgeReporter
    from arxiv_intel.knowledge import KnowledgeBase
...
def fetch(since: Optional[str], analyze: bool):
    ...
    from arxiv_intel.embedding import embed_batch, is_available, paper_text, vec_to_blob
    if is_available():
...
def direction(name: str, open_browser: bool, refresh: bool, no_live: bool, arxiv_results: int):
    ...
    """
    from arxiv_intel.fetcher.live_search import live_survey_search, live_to_paper
    ...
    if not no_live:
        with console.status(
            ...
            try:
                from arxiv_intel.fetcher.live_search import LivePaper
...
def professor(name: str, no_live: bool):
    ...
    your local database.
    """
    from arxiv_intel.fetcher.live_search import search_arxiv_by_author, enrich_with_citations, live_to_paper
...
def survey(area: str, open_browser: bool, arxiv_results: int, no_live: bool):
    ...
    """
    from arxiv_intel.analyzer.claude_client import get_client
    from arxiv_intel.fetcher.live_search import LivePaper, live_survey_search
...
def schedule():
    ...
    try:
        ...
        from arxiv_intel.reporter import DailyReporter
        from arxiv_intel.fetcher import FetchCoordinator
        from arxiv_intel.analyzer import PaperAnalyzer
        from arxiv_intel.knowledge import KnowledgeBase
...
def web(host: str, port: int):
    ...
    import uvicorn
    from arxiv_intel.web.app import create_app as create_web_app
    from arxiv_intel.config import get_config
    from arxiv_intel.database import Database
...
def tui():
    ...
    try:
        from arxiv_intel.tui.app import ArxivTUI
